...
export default function PaymentPage() {
  ...
  const handleCopyAccountNumber = () => {
    navigator.clipboard.writeText("5770506883")
        ...
        <div className="border border-gray-300 rounded-md overflow-hidden mb-6">
          <div className="bg-gray-100 p-4 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">5770506883</p>
                <button
            ...
            <div>
              ...
              <p className="font-bold">MONIEPONT MFB</p>
            </div>

            <div>
              <p className="text-gray-700 mb-1">Account Name</p>
              <p className="font-bold">OMOTOLA TOPE  AKINDASA</p>
            </div>
          </div>
